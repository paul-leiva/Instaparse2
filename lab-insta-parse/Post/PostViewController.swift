...
class PostViewController: UIViewController {
                    ...
                    if var currentUser = User.current {
                        ...
                        currentUser.save { [weak self] result in
                            ...
                            case .success(let user):
                                ...
                                /// Switch to the main thread of any UI updates
                                DispatchQueue.main.async {
    ...
    @IBAction func onTakePhotoTapped(_ sender: Any) {
        ...
        /// Show the camera vs. the photo library
        imagePicker.sourceType = .camera
        
        /// Allows user to edit image within image picker (i.e. crop, etc.)
        /// If you don't want to allow editing, you can leave out this line because the default value of `allowsEditing` is `false`
        // imagePicker.allowsEditing = true
        
        /// The image picker (camera in this case) will return captured photos via it's delegate method to its assigned delegate.
        /// Deleate assignee must conform and implement both `UIImagePickerControllerDelegate` and `UINavigationControllerDelegate`
